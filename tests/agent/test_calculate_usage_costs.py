...
class TestCalculateUsageCosts:
    """Test suite for usage cost calculation."""
    ...
    def test_usage_with_multiple_cached_details(self):
    ...
    def test_fallback_to_first_model_pricing(self):
    ...
    def test_detail_without_cached_tokens_attribute(self):
    ...
    def test_cumulative_total_cost(self):
